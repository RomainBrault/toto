...
# Foreword
    ...
    [CONTRIBUTING.md](https://github.com/RomainBrault/toto/blob/main/CONTRIBUTING.md).
...
# Checklist:
  ...
  - Quality check
    ...
    - I agree to follow this project's [Code of Conduct](https://github.com/RomainBrault/toto/blob/main/CODE_OF_CONDUCT.md)
    - I have read the [Contributor Guide](https://github.com/RomainBrault/toto/blob/main/CONTRIBUTING.md)
